...
/* effect: coverflow | slide | fade */

var Swiper = new Swiper('.swiper-container', {direction:'vertical', observer:true, observeParents:true, loop:true, effect:'slide', speed:500, keyboard:true, pagination:{el:'.swiper-pagination', type:'fraction',}, on:{slideChangeTransitionStart:function(e){if($('.swiper-slide-active').hasClass('is_blank')){$('footer,.sidebar,.swiper-pagination').hide(300);}else{$('footer,.sidebar,.swiper-pagination').show();}},},lazy:{loadPrevNext:true,},}); 